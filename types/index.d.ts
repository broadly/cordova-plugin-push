...
// Project: https://github.com/broadly/cordova-plugin-push
...
declare namespace PhonegapPluginPush {
	...
	interface InitOptions {
		...
		ios?: {
			 ...
			 * Action Buttons on iOS - https://github.com/broadly/cordova-plugin-push/blob/master/docs/PAYLOAD.md#action-buttons-1
			 */
